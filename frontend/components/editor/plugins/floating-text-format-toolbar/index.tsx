...
import { INSERT_INLINE_COMMAND } from 'components/editor/plugins/comment';
...
function TextFormatFloatingToolbar({
  ...
  return (
    <div
      ...
      className="flex flex-row bg-neutral-50 dark:bg-neutral-850 items-center gap-1 floating-text-format-popup"
    >
      <Button
        onClick={async () => {
          insertComment();
